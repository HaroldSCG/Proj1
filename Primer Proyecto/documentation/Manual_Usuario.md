...
- **Ejemplo a ejecutar (Suponiendo CuentaID = 1007)**:
  ```sql
  CALL SP_RegistrarDeposito(1007, 150.00, 'Depósitos de efectivo prueba', 501);
  ```
- **Captura de Ejecución**:
  > *[CAPTURA: Muestra consola arrojando que el depósito fue exitoso]*
  > ![Ejecución de SP_RegistrarDeposito](./4.PNG)
...
- **Ejemplo a ejecutar**:
  ```sql
  CALL SP_RegistrarRetiro(1007, 50.00, 'Retiro de cajero', 501);
  ```
- **Captura de Ejecución**:
  > *[CAPTURA: Mostrando el retiro concretándose sin error]*
  > ![Ejecución de SP_RegistrarRetiro](./5.PNG)
...
- **Ejemplo a ejecutar**:
  ```sql
  CALL SP_RealizarTransferencia(1007, 1008, 200.00);
  ```
- **Captura de Ejecución**:
  > *[CAPTURA: Realiza el llamado al procedimiento y pantallazo al éxito de transferencia]*
  > ![Ejecución de SP_RealizarTransferencia](./6.PNG)
...
- **Captura de Ejecución**:
  ...
  > ![Ejecución de SP_ReporteClientesSucursal](./7.PNG)
...
- **Captura de Ejecución**:
  ...
  > ![Ejecución de SP_ActualizarCliente](./8.PNG)
...
- **Ejemplo a ejecutar**:
  ```sql
  CALL SP_ReporteMovimientosCuenta(1007, '2026-06-01', '2026-06-30');
  ```
- **Captura de Ejecución**:
  > *[CAPTURA: GRID de la tabla de resultado obteniendo el historial]*
  > ![Ejecución de SP_ReporteMovimientosCuenta](./10.PNG)
...
- **Ejemplo a ejecutar**:
  ```sql
  CALL SP_CerrarCuenta(1007);
  ```
- **Captura de Ejecución**:
  > *[CAPTURA: Éxito de la consulta cambiando a cerrada]*
  > ![Ejecución de SP_CerrarCuenta](./11.PNG)
...
> ![Concurrencia](./CONCUERRENCIA.PNG)
> 
> ![DEADLOCK](./DEAD.PNG)
